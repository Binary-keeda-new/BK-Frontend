...
const PAGES: PageDef[] = [
  ...
  },
  {
    ...
    tags: [
      ...
      { label: "Computer Networks", keywords: ["computer networks", "networking", "networks", "DCN", "dcn"] },
      { label: "Computer Organisation & Architecture", keywords: ["computer organisation", "computer organization", "computer architecture", "coa", "COA"] },
      ...
      { label: "Operating Systems", keywords: ["operating systems", "operating system", "os", "OS"] },
