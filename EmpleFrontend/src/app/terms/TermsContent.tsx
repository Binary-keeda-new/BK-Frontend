          ...
          <div className="space-y-12 text-gray-300 leading-relaxed text-justify">
            ...
            <section id="acceptance" className="scroll-mt-[100px]">
              ...
              <div className="space-y-4">
                ...
                <p>By using this platform, you acknowledge and agree that anonymized and aggregated data generated through the website may be used for academic research, analytical, and product improvement purposes.</p>
              </div>
            </section>
            ...
            <section id="intellectual-property" className="scroll-mt-[100px]">
              ...
              <div className="space-y-4">
                <p><strong className="text-white font-medium">AI-Generated Content:</strong> The content on this platform is generated by artificial intelligence and sourced from the public domain. We do not claim ownership of any content. Our software tools are provided solely to facilitate your access to this information.</p>
