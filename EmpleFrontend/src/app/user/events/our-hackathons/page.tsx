...
export default function OurHackathonsPage() {
  const router = useRouter()
  const { events, loading } = useEventsByCategory('our-hackathon')
  ...
  return (
    <div className="flex-1 overflow-y-auto p-4 sm:p-6 md:p-[22px_24px]">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <div>
          <h1 className="text-white text-2xl font-bold">Our Hackathons</h1>
          <p className="text-white/40 text-sm">Hackathons hosted exclusively on the Emple platform.</p>
        </div>
      </div>
