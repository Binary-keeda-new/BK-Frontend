...
export default async function TutorialSubjectPage({ params }: { params: { slug: string } }) {
  ...
  // Note: we don't pass onBack anymore since the child component should use Next/Link to go back.
  // We will need to update the child components' Back buttons in a separate pass.
