          ...
          <form className="auth-form" onSubmit={handleSubmit}>
            <div className="auth-field">
              ...
              <div className="auth-input-wrap">
                <input className="auth-input" type="text" placeholder="" value={form.name} onChange={(e) => update('name', e.target.value)} autoComplete="name" />
              </div>
            </div>
            ...
            <div className="auth-field">
              ...
              <div className="auth-input-wrap">
                <input className="auth-input" type="email" placeholder="" value={form.email} onChange={(e) => update('email', e.target.value)} autoComplete="email" />
              </div>
            </div>
            ...
            <div className="auth-field">
              ...
              <div className="auth-input-wrap">
                <input className="auth-input has-toggle" type={showPassword ? 'text' : 'password'} placeholder="Min. 8 characters" value={form.password} onChange={(e) => update('password', e.target.value)} autoComplete="new-password" />
                <button type="button" className="auth-input-toggle" onClick={() => setShowPassword(!showPassword)} aria-label="Toggle password">
            ...
            <div className="auth-field">
              ...
              <div className="auth-input-wrap">
                <input
                  ...
                  style={{
                    borderColor: form.confirm ? form.confirm === form.password ? 'rgba(34,197,94,0.5)' : 'rgba(239,68,68,0.5)' : undefined,
                  }}
                />
