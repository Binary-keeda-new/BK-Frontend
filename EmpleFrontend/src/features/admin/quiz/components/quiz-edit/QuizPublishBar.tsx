    ...
    >
      ...
      <div className="flex gap-2.5">
        ...
        <button
          ...
          onClick={onPublish}
          disabled={saving}
          className="flex items-center gap-2 rounded-xl bg-[var(--clr-accent)] px-7 py-[11px] text-sm font-bold text-white transition-all hover:-translate-y-0.5 hover:shadow-[0_10px_28px_rgba(241,90,34,0.25)] active:translate-y-0 disabled:opacity-60"
        >
