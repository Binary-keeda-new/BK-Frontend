...
//import CreateCodingProblemModal from '../../coding-problems/components/createCodingProblems'
//
...
//        onCreate={async (data) => {
//          try {
//            await fetch('http://localhost:5000/api/v1/admin/coding-problems', {
//              method: 'POST',
//              headers: {
...
//      
//            // optional feedback
//            console.log('Coding problem created successfully');
//      
//          } catch (err) {
...
//          onClose={() => setIsCodingModalOpen(false)}
//          onCreate={(data) => {
//            console.log('Mock created problem:', data)
//        
//            // just close modal
//            setIsCodingModalOpen(false)
//          }}
