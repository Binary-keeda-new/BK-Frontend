export default function ReportSkeleton() {
  return (
    <div className="mx-auto w-full max-w-7xl px-4 py-8 md:px-6">
      {/* Header Skeleton */}
      <div className="mb-6 rounded-3xl border border-[var(--border)] bg-[var(--surface)] p-6 shadow-sm">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
          ...
          <div className="col-span-1 grid grid-cols-1 gap-4 sm:grid-cols-2 md:col-span-2 lg:col-span-3 lg:grid-cols-4">
            <div className="flex h-32 flex-col items-center justify-center rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-5">
          ...
          <div className="col-span-1 h-96 animate-pulse rounded-3xl border border-[var(--border)] bg-[var(--surface)] shadow-sm"></div>
          <div className="col-span-1 h-96 animate-pulse rounded-3xl border border-[var(--border)] bg-[var(--surface)] shadow-sm"></div>
        </div>
      </div>
    </div>
