...
export default function OsQuestionsPage() {
  return (
    <div className="p-6">
      <div className="mb-6">
        <h1 style={{ fontFamily: "var(--font-syne, sans-serif)", fontSize: "22px", fontWeight: 800, color: "var(--text)" }}>Operating Systems Interview Questions</h1>
        <p style={{ color: "var(--muted2)", marginTop: "6px" }}>Top 50 OS questions with detailed solutions (will be added).</p>
      </div>
